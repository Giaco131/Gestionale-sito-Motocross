...
if(isset($_COOKIE['id'])) {
	...
	$dati = $database->selezionaOrari($_COOKIE['id']);
	if($dati!=null) {?>
<!DOCTYPE html>
<html>
	<head>
		...
		<center>
			<div class='container'>
				...
				<div class='visualizza'>
					<h1>Orari</h1>
					<?php stampaTabelle(['Giorno','Da','A'],$dati); ?>
				</div>
			</div>
		</center>
	</body>
	...
	<?php } else {
		header('Location: ../php/visualizza.php?result=nope&message=Nessun%20orario%20disponibile%20%2e');
	}
