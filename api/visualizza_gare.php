...
if(isset($_COOKIE['id'])) {
	...
	$dati = $database->selezionaGare($_COOKIE['id']);
	if($dati!=null) {?>
<!DOCTYPE html>
<html>
	<head>
		...
		<center>
			<div class='container'>
				...
				<div class='visualizza'>
					<h1>Gare</h1>
					<?php stampaTabelle(['Nome','Data','Categorie'],$dati); ?>
				</div>
			</div>
		</center>
	</body>
	...
	<?php } else {
		header('Location: ../php/visualizza.php?result=nope&message=Nessuna%20gara%20disponibile%20%2e');
	}
