...
if(isset($_COOKIE['id'])) {
	...
	$dati = $database->selezionaAbbonamenti($_COOKIE['id']);
	if($dati!=null) {?>
<!DOCTYPE html>
<html>
	<head>
		...
		<center>
			<div class='container'>
				...
				<div class='visualizza'>
					<h1>Abbonamenti</h1>
					<?php stampaTabelle(['Nome','Prezzo','Durata'],$dati); ?>
				</div>
			</div>
		</center>
	</body>
	...
	<?php } else {
		header('Location: ../php/visualizza.php?result=nope&message=Nessun%20abbonamento%20disponibile%20%2e');
	}
